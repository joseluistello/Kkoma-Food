        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-12 box">
                ...
                <template v-if="cartTotalLength">
                    ...
                    <button class="button is-dark" @click="submitForm">Paga con Stripe</button>
                </template>
...
export default {
    ...
    mounted() {
        ...
        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51K3z6VHNHeLGD4Tdl3rmrK0zFo9YxxMcnpHd10CzLa0Tv7eoJqjLnduIIx3CpIWYOj4mE5miTiuv5Sbtv7zemvY0001oaYU8S9')
    ...
    methods: {
            ...
            if (!this.errors.length) {
                ...
                this.stripe.createToken(this.card).then(result => {                    
                    if (result.error) {
                        ...
                        this.errors.push('Algo esta MAAAAL')
        ...
        async stripeTokenHandler(token) {
            ...
            await axios
                ...
                .catch(error => {
                    this.errors.push('Algo esta mal. Intentalo de nuevo.')
                    console.log(error)
                })
                this.$store.commit('setIsLoading', false)
        }
